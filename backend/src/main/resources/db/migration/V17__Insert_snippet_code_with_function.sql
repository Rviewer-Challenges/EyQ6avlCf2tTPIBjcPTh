...
declare
	...
	_tag_name varchar = '';
	BEGIN
        INSERT INTO app.snippet_code(create_by, modify_by, create_at, modify_at, "version", is_enable, snippet_code_uid, code, description, title, proglang_version_uid)
